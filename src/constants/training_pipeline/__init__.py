...
PIPELINE_NAME:str = "DementiaPrediction"
ARTIFACT_DIR:str = "Artifacts"
FILE_NAME:str = "DementiaData.csv"
...
DATA_INGESTION_COLLECTION_NAME: str ="DementiaData"
DATA_INGESTION_DATABASE_NAME: str ="Adagard"
